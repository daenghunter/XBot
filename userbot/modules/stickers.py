...
async def kang(args):
    ...
    if photo:
        ...
        await args.edit(f"Stiker Berhasil Di Colong!\
            \n[Klik Disini!](t.me/addstickers/{packname}\nJika Ingin Menggunakan Stikernya Boss)",
                        parse_mode='md')
...
async def get_pack_info(event):
    ...
    try:
        ...
        await event.edit(
            "`Proses Membuka Celana Gambar, please wait..`")
    except BaseException:
        await event.edit("`Ini Bukan Sticker Goblokk!!..`")
        return
...
async def sticker_to_png(sticker):
    ...
    try:
        ...
        await sticker.edit("`Ini Bukan Sticker Goblokk...`")
        return
